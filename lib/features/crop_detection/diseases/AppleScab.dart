...
class AppleScab extends StatefulWidget {
  AppleScab({Key? key, required this.title}) : super(key: key);
  final String title;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: <Widget>[
            ...
            SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Carousel(
                      images: [
                        AssetImage('assets/crops/1.jpg'),
                        // Photo from https://unsplash.com/photos/2d4lAQAlbDA
                        AssetImage('assets/crops/2.jpg'),
                        // Photo from https://unsplash.com/photos/FqqiAvJejto
                        AssetImage('assets/crops/3.jpg'),
        ...
        Padding(
          padding: EdgeInsets.only(top: 20, bottom: 20, left: 14, right: 14),
          child: Image.asset('assets/crops/AppleScabCycle.jpg'),
        ),
        Padding(
