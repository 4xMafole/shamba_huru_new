...
class GrapeBlackRot extends StatefulWidget {
  GrapeBlackRot({Key? key, required this.title}) : super(key: key);
  final String title;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: <Widget>[
            ...
            SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Carousel(
                      images: [
                        AssetImage('assets/crops/25.jpg'),
                        // Photo from https://unsplash.com/photos/2d4lAQAlbDA
                        AssetImage('assets/crops/26.jpg'),
                        // Photo from https://unsplash.com/photos/FqqiAvJejto
                        AssetImage('assets/crops/27.jpg'),
        ...
        Padding(
          padding: EdgeInsets.only(top: 20, bottom: 20, left: 14, right: 14),
          child: Image.asset('assets/crops/BlackRotDiseaseCycle.png'),
        ),
        Padding(
          padding: EdgeInsets.only(top: 40, bottom: 20, left: 14),
          child: Text(
