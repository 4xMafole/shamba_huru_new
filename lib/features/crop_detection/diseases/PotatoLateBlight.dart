...
class PotatoLateBlight extends StatefulWidget {
  PotatoLateBlight({Key? key, required this.title}) : super(key: key);
  final String title;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: <Widget>[
            ...
            SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Carousel(
                      images: [
                        AssetImage('assets/crops/19.jpg'),
                        AssetImage('assets/crops/20.jpg'),
                        AssetImage('assets/crops/21.jpg'),
                      ],
                      dotSize: 4.0,
                      dotSpacing: 15.0,
                      autoplay: false,
        ...
        Padding(
          padding: EdgeInsets.only(top: 20, bottom: 20, left: 14, right: 14),
          child: Image.asset('assets/crops/PotatoLateCycle.jpg'),
        ),
        Padding(
          padding: EdgeInsets.only(top: 40, bottom: 20, left: 14, right: 14),
          child: Text(
